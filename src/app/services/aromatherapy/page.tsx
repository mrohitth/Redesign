...
export default function AromatherapyPage() {
  const service = getServiceBySlug('aromatherapy')!
  return (
    <>
      ...
      <section className="py-16 bg-sage text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-4">Engage Your Senses, Heal Your Body</h2>
          <p className="text-white/80 text-lg mb-6">The power of scent meets the healing power of touch. Book your aromatherapy session today.</p>
