...
export default function BodyScrubPage() {
  const service = getServiceBySlug('body-scrub')!
  return (
    <>
      ...
      <section className="py-16 bg-sage text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-4">Reveal Your Radiant Skin</h2>
          <p className="text-white/80 text-lg mb-6">Exfoliate, nourish, and glow. Book your body scrub treatment today.</p>
