...
export default function TriggerPointPage() {
  const service = getServiceBySlug('trigger-point')!
  return (
    <>
      ...
      <section className="py-16 bg-sage text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-4">Release Chronic Pain Patterns</h2>
          <p className="text-white/80 text-lg mb-6">Find relief from persistent muscle knots and referred pain. Book your trigger point session.</p>
